...
const KnowledgeCard = (props: KnowledgeCardProps) => {
  return (
    <div className="flex flex-col items-center rounded border-solid bg-white p-5 text-slate-900 shadow-md shadow-white/40 transition-all duration-1000 cursor-pointer hover:scale-95 hover:bg-slate-700 hover:text-white">
